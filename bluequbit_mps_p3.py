...
print("Starting BlueQubit SDK approach with MPS simulator...")
...
try:
    ...
    # Now run the circuit on the MPS.GPU simulator (can handle up to 96 qubits)
    print("\nSubmitting job to BlueQubit MPS.GPU simulator...")
    job = bq.run(qc, device='mps.gpu', shots=1000, job_name="P3 Sharp Peak Analysis")
